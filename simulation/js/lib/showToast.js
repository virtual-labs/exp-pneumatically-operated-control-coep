...
var showToast=(function(){
    var instance=null;
        function show(text,status,timer){
            if(!timer){
                timer = 3500;
            }
            if(!instance){
                ...
                var $container=$('<div class="showToast"><div class="showToastInner"><div class="showToastTips fieldTipBounceIn"><div class="showToastCon">'+text+'</div></div></div></div>');
            		...
            		var $container=$('<div class="showToast"><div class="showToastInner"><div class="showToastTips1 fieldTipBounceIn"><div class="showToastCon1">'+text+'</div></div></div></div>');	
            	}
